...
File::HashCache::JavaScript is an automatic versioning scheme for Javascript based on
the hash of the contents of the Javascript files themselves. It aims to be
painless for the developer and very fast.

File::HashCache::JavaScript solves the problem in web development where you update some
...
The best place to use File::HashCache::JavaScript is in your HTML template code. While
...
HTML, the L<File::HashCache::JavaScript> code lazily takes care of rebuilding any
...
This code is now a short wrapper around L<File::HashCache>, a more generic
(and currently undocumented) library.
